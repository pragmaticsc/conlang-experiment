#!/usr/bin/env bash
# Download and prepare Simple English Wikipedia corpus.
#
# Usage:
#   ./data/download-english.sh [--output-dir data/raw/english] [--max-articles 50000]
#
# Output:
